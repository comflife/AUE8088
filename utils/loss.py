...
class ComputeLoss:
    ...
    def __init__(self, model, autobalance=False):
        ...
        # IoU type selection
        self.use_ciou = h.get("use_ciou", True)  # use CIoU by default
        self.use_piou = h.get("use_piou", False)  # PIoU is disabled by default
        self.use_fpdiou = h.get("use_fpdiou", False)  # FPDIoU is enabled by default
    ...
    def __call__(self, p, targets):  # predictions, targets
        ...
        for i, pi in enumerate(p):  # layer index, layer predictions
            ...
            if n:
                ...
                iou = bbox_iou(pbox, tbox[i], CIoU=self.use_ciou, PIoU=self.use_piou, FPDIoU=self.use_fpdiou).squeeze()  # iou(prediction, target)
